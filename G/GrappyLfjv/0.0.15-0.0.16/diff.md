# Comparing `tmp/GrappyLfjv-0.0.15.tar.gz` & `tmp/GrappyLfjv-0.0.16.tar.gz`
...
## Comparing `GrappyLfjv-0.0.15.tar` & `GrappyLfjv-0.0.16.tar`
...
### Comparing `GrappyLfjv-0.0.15/LICENSE` & `GrappyLfjv-0.0.16/LICENSE`

 * *Files identical despite different names*

### Comparing `GrappyLfjv-0.0.15/src/grappy.py` & `GrappyLfjv-0.0.16/src/grappy.py`
