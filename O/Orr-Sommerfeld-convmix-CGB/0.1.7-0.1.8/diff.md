# Comparing `tmp/orr_sommerfeld_convmix_cgb-0.1.7.tar.gz` & `tmp/orr_sommerfeld_convmix_cgb-0.1.8.tar.gz`

## Comparing `orr_sommerfeld_convmix_cgb-0.1.7.tar` & `orr_sommerfeld_convmix_cgb-0.1.8.tar`
...
### Comparing `orr_sommerfeld_convmix_cgb-0.1.7/src/Orr_Sommerfeld_convmix_CGB/OS_CM.py` & `orr_sommerfeld_convmix_cgb-0.1.8/src/Orr_Sommerfeld_convmix_CGB/OS_CM.py`
...
### Comparing `orr_sommerfeld_convmix_cgb-0.1.7/LICENSE` & `orr_sommerfeld_convmix_cgb-0.1.8/LICENSE`

 * *Files identical despite different names*

### Comparing `orr_sommerfeld_convmix_cgb-0.1.7/pyproject.toml` & `orr_sommerfeld_convmix_cgb-0.1.8/pyproject.toml`
...
### Comparing `orr_sommerfeld_convmix_cgb-0.1.7/PKG-INFO` & `orr_sommerfeld_convmix_cgb-0.1.8/PKG-INFO`
