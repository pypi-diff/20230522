# Comparing `tmp/aiextras-0.0.3.tar.gz` & `tmp/aiextras-0.0.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist\aiextras-0.0.3.tar", last modified: Mon May 22 04:09:07 2023, max compression
+gzip compressed data, was "dist\aiextras-0.0.4.tar", last modified: Mon May 22 04:12:09 2023, max compression
```

## Comparing `aiextras-0.0.3.tar` & `aiextras-0.0.4.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxrwxrwx   0        0        0        0 2023-05-22 04:09:07.000000 aiextras-0.0.3/
--rw-rw-rw-   0        0        0        0 2023-05-22 03:45:14.000000 aiextras-0.0.3/LICENSE
--rw-rw-rw-   0        0        0      338 2023-05-22 04:09:07.000000 aiextras-0.0.3/PKG-INFO
--rw-rw-rw-   0        0        0        0 2023-05-20 09:12:45.000000 aiextras-0.0.3/README.md
-drwxrwxrwx   0        0        0        0 2023-05-22 04:09:07.000000 aiextras-0.0.3/programs/
-drwxrwxrwx   0        0        0        0 2023-05-22 04:09:07.000000 aiextras-0.0.3/programs/src/
-drwxrwxrwx   0        0        0        0 2023-05-22 04:09:07.000000 aiextras-0.0.3/programs/src/aiextras.egg-info/
--rw-rw-rw-   0        0        0      338 2023-05-22 04:09:07.000000 aiextras-0.0.3/programs/src/aiextras.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      396 2023-05-22 04:09:07.000000 aiextras-0.0.3/programs/src/aiextras.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-05-22 04:09:07.000000 aiextras-0.0.3/programs/src/aiextras.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        9 2023-05-22 04:09:07.000000 aiextras-0.0.3/programs/src/aiextras.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       86 2023-05-22 04:09:07.000000 aiextras-0.0.3/setup.cfg
--rw-rw-rw-   0        0        0     1206 2023-05-22 04:09:02.000000 aiextras-0.0.3/setup.py
...
### Comparing `aiextras-0.0.3/setup.py` & `aiextras-0.0.4/setup.py`
