# Comparing `tmp/ambient-toolbox-8.3.5.tar.gz` & `tmp/ambient-toolbox-8.4.0.tar.gz`
...
### Comparing `ambient-toolbox-8.3.5/.gitlab-ci.yml` & `ambient-toolbox-8.4.0/.gitlab-ci.yml`
...
### Comparing `ambient-toolbox-8.3.5/ambient_toolbox/context_manager.py` & `ambient-toolbox-8.4.0/ambient_toolbox/context_manager.py`
...
### Comparing `ambient-toolbox-8.3.5/docs/features/admin.md` & `ambient-toolbox-8.4.0/docs/features/admin.md`
...
### Comparing `ambient-toolbox-8.3.5/docs/features/models.md` & `ambient-toolbox-8.4.0/docs/features/models.md`
...
### Comparing `ambient-toolbox-8.3.5/tests/admin/model_admin_mixins/test_fetch_parent_object_inline_mixin.py` & `ambient-toolbox-8.4.0/tests/admin/model_admin_mixins/test_fetch_parent_object_inline_mixin.py`
...
### Comparing `ambient-toolbox-8.3.5/tests/query_selectors/test_permission.py` & `ambient-toolbox-8.4.0/tests/query_selectors/test_permission.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/sentry/mock_data.py` & `ambient-toolbox-8.4.0/tests/sentry/mock_data.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/sentry/test_sentry_helper.py` & `ambient-toolbox-8.4.0/tests/sentry/test_sentry_helper.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_admin_forms.py` & `ambient-toolbox-8.4.0/tests/test_admin_forms.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_admin_inlines.py` & `ambient-toolbox-8.4.0/tests/test_admin_inlines.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_admin_model_admins_classes.py` & `ambient-toolbox-8.4.0/tests/test_admin_model_admins_classes.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_admin_view_mixins.py` & `ambient-toolbox-8.4.0/tests/test_admin_view_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_context_manager.py` & `ambient-toolbox-8.4.0/tests/test_context_manager.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_log_whodid.py` & `ambient-toolbox-8.4.0/tests/test_log_whodid.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_managers.py` & `ambient-toolbox-8.4.0/tests/test_managers.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_math.py` & `ambient-toolbox-8.4.0/tests/test_math.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_mixins_models.py` & `ambient-toolbox-8.4.0/tests/test_mixins_models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_models.py` & `ambient-toolbox-8.4.0/tests/test_models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_rest_api_mixins.py` & `ambient-toolbox-8.4.0/tests/test_rest_api_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_scrubbing_service.py` & `ambient-toolbox-8.4.0/tests/test_scrubbing_service.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_utils_date.py` & `ambient-toolbox-8.4.0/tests/test_utils_date.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_utils_file.py` & `ambient-toolbox-8.4.0/tests/test_utils_file.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_utils_model.py` & `ambient-toolbox-8.4.0/tests/test_utils_model.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_utils_named_tuple.py` & `ambient-toolbox-8.4.0/tests/test_utils_named_tuple.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/test_utils_string.py` & `ambient-toolbox-8.4.0/tests/test_utils_string.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/tests/mixins/test_django_message_framework.py` & `ambient-toolbox-8.4.0/tests/tests/mixins/test_django_message_framework.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/tests/mixins/test_request_provider_mixin.py` & `ambient-toolbox-8.4.0/tests/tests/mixins/test_request_provider_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/tests/test_mail_backends.py` & `ambient-toolbox-8.4.0/tests/tests/test_mail_backends.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/view_layer/test_formset_mixins.py` & `ambient-toolbox-8.4.0/tests/view_layer/test_formset_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/view_layer/test_htmx_response_mixin.py` & `ambient-toolbox-8.4.0/tests/view_layer/test_htmx_response_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/view_layer/test_meta_mixins.py` & `ambient-toolbox-8.4.0/tests/view_layer/test_meta_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/tests/view_layer/test_views.py` & `ambient-toolbox-8.4.0/tests/view_layer/test_views.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.3.5/PKG-INFO` & `ambient-toolbox-8.4.0/PKG-INFO`
