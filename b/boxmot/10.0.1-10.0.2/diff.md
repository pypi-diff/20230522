# Comparing `tmp/boxmot-10.0.1.tar.gz` & `tmp/boxmot-10.0.2.tar.gz`
...
### Comparing `boxmot-10.0.1/boxmot.egg-info/SOURCES.txt` & `boxmot-10.0.2/boxmot.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `boxmot-10.0.1/setup.py` & `boxmot-10.0.2/setup.py`
