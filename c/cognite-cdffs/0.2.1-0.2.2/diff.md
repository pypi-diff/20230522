# Comparing `tmp/cognite_cdffs-0.2.1.tar.gz` & `tmp/cognite_cdffs-0.2.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "cognite_cdffs-0.2.1.tar", max compression
+gzip compressed data, was "cognite_cdffs-0.2.2.tar", max compression
```

## Comparing `cognite_cdffs-0.2.1.tar` & `cognite_cdffs-0.2.2.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     2423 2023-04-05 09:33:39.713774 cognite_cdffs-0.2.1/README.md
--rw-r--r--   0        0        0      205 2023-04-05 09:33:39.713774 cognite_cdffs-0.2.1/cognite/cdffs/__init__.py
--rw-r--r--   0        0        0     3907 2023-04-05 09:33:39.713774 cognite_cdffs-0.2.1/cognite/cdffs/credentials.py
--rw-r--r--   0        0        0     3134 2023-04-05 09:33:39.713774 cognite_cdffs-0.2.1/cognite/cdffs/file_handler.py
--rw-r--r--   0        0        0    26358 2023-04-05 09:33:39.713774 cognite_cdffs-0.2.1/cognite/cdffs/spec.py
--rw-r--r--   0        0        0     1656 2023-04-05 09:33:39.717774 cognite_cdffs-0.2.1/pyproject.toml
--rw-r--r--   0        0        0     3338 1970-01-01 00:00:00.000000 cognite_cdffs-0.2.1/setup.py
--rw-r--r--   0        0        0     3149 1970-01-01 00:00:00.000000 cognite_cdffs-0.2.1/PKG-INFO
...
### Comparing `cognite_cdffs-0.2.1/README.md` & `cognite_cdffs-0.2.2/README.md`

 * *Files identical despite different names*

### Comparing `cognite_cdffs-0.2.1/cognite/cdffs/credentials.py` & `cognite_cdffs-0.2.2/cognite/cdffs/credentials.py`

 * *Files identical despite different names*

### Comparing `cognite_cdffs-0.2.1/cognite/cdffs/file_handler.py` & `cognite_cdffs-0.2.2/cognite/cdffs/file_handler.py`

 * *Files identical despite different names*

### Comparing `cognite_cdffs-0.2.1/cognite/cdffs/spec.py` & `cognite_cdffs-0.2.2/cognite/cdffs/spec.py`

 * *Files identical despite different names*

### Comparing `cognite_cdffs-0.2.1/pyproject.toml` & `cognite_cdffs-0.2.2/pyproject.toml`
...
### Comparing `cognite_cdffs-0.2.1/setup.py` & `cognite_cdffs-0.2.2/setup.py`
...
-install_requires = \ ['cognite-sdk>=5.10.1,<6.0.0',
-'fsspec>=2023.3.0,<2024.0.0', 'pydantic>=1.10.7,<2.0.0', 'python-
-dotenv>=1.0.0,<2.0.0', 'requests>=2.28.1,<3.0.0', 'twine>=4.0.2,<5.0.0']
-setup_kwargs = { 'name': 'cognite-cdffs', 'version': '0.2.1', 'description':
...
### Comparing `cognite_cdffs-0.2.1/PKG-INFO` & `cognite_cdffs-0.2.2/PKG-INFO`
...
-Requires-Dist: fsspec (>=2023.3.0,<2024.0.0)
...
```diff
@@ -1,16 +1,16 @@
-Metadata-Version: 2.1 Name: cognite-cdffs Version: 0.2.1 Summary: File System
...
-(>=5.10.1,<6.0.0) Requires-Dist: fsspec (>=2023.3.0,<2024.0.0) Requires-Dist:
...
-Requires-Dist: requests (>=2.28.1,<3.0.0) Requires-Dist: twine (>=4.0.2,<5.0.0)
