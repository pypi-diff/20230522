# Comparing `tmp/funasr-0.5.4.tar.gz` & `tmp/funasr-0.5.5.tar.gz`
...
### Comparing `funasr-0.5.4/LICENSE` & `funasr-0.5.5/LICENSE`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/PKG-INFO` & `funasr-0.5.5/PKG-INFO`
...
### Comparing `funasr-0.5.4/README.md` & `funasr-0.5.5/README.md`
...
### Comparing `funasr-0.5.4/funasr/bin/aggregate_stats_dirs.py` & `funasr-0.5.5/funasr/bin/aggregate_stats_dirs.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/asr_infer.py` & `funasr-0.5.5/funasr/bin/asr_infer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/asr_inference_launch.py` & `funasr-0.5.5/funasr/bin/asr_inference_launch.py`
...
### Comparing `funasr-0.5.4/funasr/bin/asr_train.py` & `funasr-0.5.5/funasr/bin/asr_train.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/data2vec_train.py` & `funasr-0.5.5/funasr/bin/data2vec_train.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/diar_infer.py` & `funasr-0.5.5/funasr/bin/diar_infer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/diar_inference_launch.py` & `funasr-0.5.5/funasr/bin/diar_inference_launch.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/diar_train.py` & `funasr-0.5.5/funasr/bin/diar_train.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/lm_inference_launch.py` & `funasr-0.5.5/funasr/bin/lm_inference_launch.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/lm_train.py` & `funasr-0.5.5/funasr/bin/lm_train.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/punc_infer.py` & `funasr-0.5.5/funasr/bin/punc_infer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/punc_inference_launch.py` & `funasr-0.5.5/funasr/bin/punc_inference_launch.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/punc_train.py` & `funasr-0.5.5/funasr/bin/punc_train.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/sa_asr_train.py` & `funasr-0.5.5/funasr/bin/sa_asr_train.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/sv_infer.py` & `funasr-0.5.5/funasr/bin/sv_infer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/sv_inference_launch.py` & `funasr-0.5.5/funasr/bin/sv_inference_launch.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/tokenize_text.py` & `funasr-0.5.5/funasr/bin/tokenize_text.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/tp_infer.py` & `funasr-0.5.5/funasr/bin/tp_infer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/tp_inference_launch.py` & `funasr-0.5.5/funasr/bin/tp_inference_launch.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/train.py` & `funasr-0.5.5/funasr/bin/train.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/vad_infer.py` & `funasr-0.5.5/funasr/bin/vad_infer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/bin/vad_inference_launch.py` & `funasr-0.5.5/funasr/bin/vad_inference_launch.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_args.py` & `funasr-0.5.5/funasr/build_utils/build_args.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_asr_model.py` & `funasr-0.5.5/funasr/build_utils/build_asr_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_dataloader.py` & `funasr-0.5.5/funasr/build_utils/build_dataloader.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_diar_model.py` & `funasr-0.5.5/funasr/build_utils/build_diar_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_distributed.py` & `funasr-0.5.5/funasr/build_utils/build_distributed.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_lm_model.py` & `funasr-0.5.5/funasr/build_utils/build_lm_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_model.py` & `funasr-0.5.5/funasr/build_utils/build_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_optimizer.py` & `funasr-0.5.5/funasr/build_utils/build_optimizer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_pretrain_model.py` & `funasr-0.5.5/funasr/build_utils/build_pretrain_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_punc_model.py` & `funasr-0.5.5/funasr/build_utils/build_punc_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_scheduler.py` & `funasr-0.5.5/funasr/build_utils/build_scheduler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_trainer.py` & `funasr-0.5.5/funasr/build_utils/build_trainer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/build_utils/build_vad_model.py` & `funasr-0.5.5/funasr/build_utils/build_vad_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/collate_fn.py` & `funasr-0.5.5/funasr/datasets/collate_fn.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/dataset.py` & `funasr-0.5.5/funasr/datasets/dataset.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/iterable_dataset.py` & `funasr-0.5.5/funasr/datasets/iterable_dataset.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/build_dataloader.py` & `funasr-0.5.5/funasr/datasets/large_datasets/build_dataloader.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/datapipes/batch.py` & `funasr-0.5.5/funasr/datasets/large_datasets/datapipes/batch.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/datapipes/filter.py` & `funasr-0.5.5/funasr/datasets/large_datasets/datapipes/filter.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/dataset.py` & `funasr-0.5.5/funasr/datasets/large_datasets/dataset.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/utils/clipping.py` & `funasr-0.5.5/funasr/datasets/large_datasets/utils/clipping.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/utils/filter.py` & `funasr-0.5.5/funasr/datasets/large_datasets/utils/filter.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/utils/hotword_utils.py` & `funasr-0.5.5/funasr/datasets/large_datasets/utils/hotword_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/utils/low_frame_rate.py` & `funasr-0.5.5/funasr/datasets/large_datasets/utils/low_frame_rate.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/utils/padding.py` & `funasr-0.5.5/funasr/datasets/large_datasets/utils/padding.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/large_datasets/utils/tokenize.py` & `funasr-0.5.5/funasr/datasets/large_datasets/utils/tokenize.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/ms_dataset.py` & `funasr-0.5.5/funasr/datasets/ms_dataset.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/datasets/preprocessor.py` & `funasr-0.5.5/funasr/datasets/preprocessor.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/export_model.py` & `funasr-0.5.5/funasr/export/export_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/CT_Transformer.py` & `funasr-0.5.5/funasr/export/models/CT_Transformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/__init__.py` & `funasr-0.5.5/funasr/export/models/__init__.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/decoder/sanm_decoder.py` & `funasr-0.5.5/funasr/export/models/decoder/sanm_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/decoder/transformer_decoder.py` & `funasr-0.5.5/funasr/export/models/decoder/transformer_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/e2e_asr_paraformer.py` & `funasr-0.5.5/funasr/export/models/e2e_asr_paraformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/e2e_vad.py` & `funasr-0.5.5/funasr/export/models/e2e_vad.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/encoder/conformer_encoder.py` & `funasr-0.5.5/funasr/export/models/encoder/conformer_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/encoder/fsmn_encoder.py` & `funasr-0.5.5/funasr/export/models/encoder/fsmn_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/encoder/sanm_encoder.py` & `funasr-0.5.5/funasr/export/models/encoder/sanm_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/modules/decoder_layer.py` & `funasr-0.5.5/funasr/export/models/modules/decoder_layer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/modules/encoder_layer.py` & `funasr-0.5.5/funasr/export/models/modules/encoder_layer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/modules/feedforward.py` & `funasr-0.5.5/funasr/export/models/modules/feedforward.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/modules/multihead_att.py` & `funasr-0.5.5/funasr/export/models/modules/multihead_att.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/models/predictor/cif.py` & `funasr-0.5.5/funasr/export/models/predictor/cif.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/test/test_onnx.py` & `funasr-0.5.5/funasr/export/test/test_onnx.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/test/test_onnx_punc.py` & `funasr-0.5.5/funasr/export/test/test_onnx_punc.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/test/test_onnx_punc_vadrealtime.py` & `funasr-0.5.5/funasr/export/test/test_onnx_punc_vadrealtime.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/test/test_onnx_vad.py` & `funasr-0.5.5/funasr/export/test/test_onnx_vad.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/export/utils/torch_function.py` & `funasr-0.5.5/funasr/export/utils/torch_function.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/fileio/datadir_writer.py` & `funasr-0.5.5/funasr/fileio/datadir_writer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/fileio/npy_scp.py` & `funasr-0.5.5/funasr/fileio/npy_scp.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/fileio/rand_gen_dataset.py` & `funasr-0.5.5/funasr/fileio/rand_gen_dataset.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/fileio/read_text.py` & `funasr-0.5.5/funasr/fileio/read_text.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/fileio/sound_scp.py` & `funasr-0.5.5/funasr/fileio/sound_scp.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/iterators/chunk_iter_factory.py` & `funasr-0.5.5/funasr/iterators/chunk_iter_factory.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/iterators/multiple_iter_factory.py` & `funasr-0.5.5/funasr/iterators/multiple_iter_factory.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/iterators/sequence_iter_factory.py` & `funasr-0.5.5/funasr/iterators/sequence_iter_factory.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/complex_utils.py` & `funasr-0.5.5/funasr/layers/complex_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/global_mvn.py` & `funasr-0.5.5/funasr/layers/global_mvn.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/label_aggregation.py` & `funasr-0.5.5/funasr/layers/label_aggregation.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/log_mel.py` & `funasr-0.5.5/funasr/layers/log_mel.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/mask_along_axis.py` & `funasr-0.5.5/funasr/layers/mask_along_axis.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/sinc_conv.py` & `funasr-0.5.5/funasr/layers/sinc_conv.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/stft.py` & `funasr-0.5.5/funasr/layers/stft.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/time_warp.py` & `funasr-0.5.5/funasr/layers/time_warp.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/layers/utterance_mvn.py` & `funasr-0.5.5/funasr/layers/utterance_mvn.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/losses/label_smoothing_loss.py` & `funasr-0.5.5/funasr/losses/label_smoothing_loss.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/main_funcs/average_nbest_models.py` & `funasr-0.5.5/funasr/main_funcs/average_nbest_models.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/main_funcs/calculate_all_attentions.py` & `funasr-0.5.5/funasr/main_funcs/calculate_all_attentions.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/main_funcs/collect_stats.py` & `funasr-0.5.5/funasr/main_funcs/collect_stats.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/main_funcs/pack_funcs.py` & `funasr-0.5.5/funasr/main_funcs/pack_funcs.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/ctc.py` & `funasr-0.5.5/funasr/models/ctc.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/data2vec.py` & `funasr-0.5.5/funasr/models/data2vec.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/decoder/contextual_decoder.py` & `funasr-0.5.5/funasr/models/decoder/contextual_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/decoder/rnn_decoder.py` & `funasr-0.5.5/funasr/models/decoder/rnn_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/decoder/rnnt_decoder.py` & `funasr-0.5.5/funasr/models/decoder/rnnt_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/decoder/sanm_decoder.py` & `funasr-0.5.5/funasr/models/decoder/sanm_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/decoder/sv_decoder.py` & `funasr-0.5.5/funasr/models/decoder/sv_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/decoder/transformer_decoder.py` & `funasr-0.5.5/funasr/models/decoder/transformer_decoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_asr.py` & `funasr-0.5.5/funasr/models/e2e_asr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_asr_common.py` & `funasr-0.5.5/funasr/models/e2e_asr_common.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_asr_contextual_paraformer.py` & `funasr-0.5.5/funasr/models/e2e_asr_contextual_paraformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_asr_mfcca.py` & `funasr-0.5.5/funasr/models/e2e_asr_mfcca.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_asr_paraformer.py` & `funasr-0.5.5/funasr/models/e2e_asr_paraformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_asr_transducer.py` & `funasr-0.5.5/funasr/models/e2e_asr_transducer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_diar_eend_ola.py` & `funasr-0.5.5/funasr/models/e2e_diar_eend_ola.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_diar_sond.py` & `funasr-0.5.5/funasr/models/e2e_diar_sond.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_sa_asr.py` & `funasr-0.5.5/funasr/models/e2e_sa_asr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_sv.py` & `funasr-0.5.5/funasr/models/e2e_sv.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_tp.py` & `funasr-0.5.5/funasr/models/e2e_tp.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_uni_asr.py` & `funasr-0.5.5/funasr/models/e2e_uni_asr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/e2e_vad.py` & `funasr-0.5.5/funasr/models/e2e_vad.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/conformer_encoder.py` & `funasr-0.5.5/funasr/models/encoder/conformer_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/data2vec_encoder.py` & `funasr-0.5.5/funasr/models/encoder/data2vec_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/ecapa_tdnn_encoder.py` & `funasr-0.5.5/funasr/models/encoder/ecapa_tdnn_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/encoder_layer_mfcca.py` & `funasr-0.5.5/funasr/models/encoder/encoder_layer_mfcca.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/fsmn_encoder.py` & `funasr-0.5.5/funasr/models/encoder/fsmn_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/mfcca_encoder.py` & `funasr-0.5.5/funasr/models/encoder/mfcca_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/opennmt_encoders/ci_scorers.py` & `funasr-0.5.5/funasr/models/encoder/opennmt_encoders/ci_scorers.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/opennmt_encoders/conv_encoder.py` & `funasr-0.5.5/funasr/models/encoder/opennmt_encoders/conv_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/opennmt_encoders/fsmn_encoder.py` & `funasr-0.5.5/funasr/models/encoder/opennmt_encoders/fsmn_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/opennmt_encoders/self_attention_encoder.py` & `funasr-0.5.5/funasr/models/encoder/opennmt_encoders/self_attention_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/resnet34_encoder.py` & `funasr-0.5.5/funasr/models/encoder/resnet34_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/rnn_encoder.py` & `funasr-0.5.5/funasr/models/encoder/rnn_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/sanm_encoder.py` & `funasr-0.5.5/funasr/models/encoder/sanm_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/encoder/transformer_encoder.py` & `funasr-0.5.5/funasr/models/encoder/transformer_encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/frontend/default.py` & `funasr-0.5.5/funasr/models/frontend/default.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/frontend/eend_ola_feature.py` & `funasr-0.5.5/funasr/models/frontend/eend_ola_feature.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/frontend/fused.py` & `funasr-0.5.5/funasr/models/frontend/fused.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/frontend/s3prl.py` & `funasr-0.5.5/funasr/models/frontend/s3prl.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/frontend/wav_frontend.py` & `funasr-0.5.5/funasr/models/frontend/wav_frontend.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/frontend/wav_frontend_kaldifeat.py` & `funasr-0.5.5/funasr/models/frontend/wav_frontend_kaldifeat.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/frontend/windowing.py` & `funasr-0.5.5/funasr/models/frontend/windowing.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/joint_net/joint_network.py` & `funasr-0.5.5/funasr/models/joint_net/joint_network.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/pooling/statistic_pooling.py` & `funasr-0.5.5/funasr/models/pooling/statistic_pooling.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/postencoder/hugging_face_transformers_postencoder.py` & `funasr-0.5.5/funasr/models/postencoder/hugging_face_transformers_postencoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/predictor/cif.py` & `funasr-0.5.5/funasr/models/predictor/cif.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/preencoder/linear.py` & `funasr-0.5.5/funasr/models/preencoder/linear.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/preencoder/sinc.py` & `funasr-0.5.5/funasr/models/preencoder/sinc.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/seq_rnn_lm.py` & `funasr-0.5.5/funasr/models/seq_rnn_lm.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/specaug/specaug.py` & `funasr-0.5.5/funasr/models/specaug/specaug.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/target_delay_transformer.py` & `funasr-0.5.5/funasr/models/target_delay_transformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/transformer_lm.py` & `funasr-0.5.5/funasr/models/transformer_lm.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/models/vad_realtime_transformer.py` & `funasr-0.5.5/funasr/models/vad_realtime_transformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/add_sos_eos.py` & `funasr-0.5.5/funasr/modules/add_sos_eos.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/attention.py` & `funasr-0.5.5/funasr/modules/attention.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/beam_search/batch_beam_search.py` & `funasr-0.5.5/funasr/modules/beam_search/batch_beam_search.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/beam_search/batch_beam_search_online_sim.py` & `funasr-0.5.5/funasr/modules/beam_search/batch_beam_search_online_sim.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/beam_search/beam_search.py` & `funasr-0.5.5/funasr/modules/beam_search/beam_search.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/beam_search/beam_search_sa_asr.py` & `funasr-0.5.5/funasr/modules/beam_search/beam_search_sa_asr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/beam_search/beam_search_transducer.py` & `funasr-0.5.5/funasr/modules/beam_search/beam_search_transducer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/data2vec/data_utils.py` & `funasr-0.5.5/funasr/modules/data2vec/data_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/data2vec/ema_module.py` & `funasr-0.5.5/funasr/modules/data2vec/ema_module.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/data2vec/multihead_attention.py` & `funasr-0.5.5/funasr/modules/data2vec/multihead_attention.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/data2vec/quant_noise.py` & `funasr-0.5.5/funasr/modules/data2vec/quant_noise.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/data2vec/utils.py` & `funasr-0.5.5/funasr/modules/data2vec/utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/data2vec/wav2vec2.py` & `funasr-0.5.5/funasr/modules/data2vec/wav2vec2.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/dynamic_conv.py` & `funasr-0.5.5/funasr/modules/dynamic_conv.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/dynamic_conv2d.py` & `funasr-0.5.5/funasr/modules/dynamic_conv2d.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/e2e_asr_common.py` & `funasr-0.5.5/funasr/modules/e2e_asr_common.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/eend_ola/encoder.py` & `funasr-0.5.5/funasr/modules/eend_ola/encoder.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/eend_ola/encoder_decoder_attractor.py` & `funasr-0.5.5/funasr/modules/eend_ola/encoder_decoder_attractor.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/embedding.py` & `funasr-0.5.5/funasr/modules/embedding.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/frontends/beamformer.py` & `funasr-0.5.5/funasr/modules/frontends/beamformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/frontends/dnn_beamformer.py` & `funasr-0.5.5/funasr/modules/frontends/dnn_beamformer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/frontends/dnn_wpe.py` & `funasr-0.5.5/funasr/modules/frontends/dnn_wpe.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/frontends/feature_transform.py` & `funasr-0.5.5/funasr/modules/frontends/feature_transform.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/frontends/frontend.py` & `funasr-0.5.5/funasr/modules/frontends/frontend.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/frontends/mask_estimator.py` & `funasr-0.5.5/funasr/modules/frontends/mask_estimator.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/layer_norm.py` & `funasr-0.5.5/funasr/modules/layer_norm.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/lightconv.py` & `funasr-0.5.5/funasr/modules/lightconv.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/lightconv2d.py` & `funasr-0.5.5/funasr/modules/lightconv2d.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/mask.py` & `funasr-0.5.5/funasr/modules/mask.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/multi_layer_conv.py` & `funasr-0.5.5/funasr/modules/multi_layer_conv.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/nets_utils.py` & `funasr-0.5.5/funasr/modules/nets_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/positionwise_feed_forward.py` & `funasr-0.5.5/funasr/modules/positionwise_feed_forward.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/repeat.py` & `funasr-0.5.5/funasr/modules/repeat.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/rnn/argument.py` & `funasr-0.5.5/funasr/modules/rnn/argument.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/rnn/attentions.py` & `funasr-0.5.5/funasr/modules/rnn/attentions.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/rnn/decoders.py` & `funasr-0.5.5/funasr/modules/rnn/decoders.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/rnn/encoders.py` & `funasr-0.5.5/funasr/modules/rnn/encoders.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/scorers/ctc.py` & `funasr-0.5.5/funasr/modules/scorers/ctc.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/scorers/ctc_prefix_score.py` & `funasr-0.5.5/funasr/modules/scorers/ctc_prefix_score.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/scorers/length_bonus.py` & `funasr-0.5.5/funasr/modules/scorers/length_bonus.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/scorers/scorer_interface.py` & `funasr-0.5.5/funasr/modules/scorers/scorer_interface.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/streaming_utils/chunk_utilis.py` & `funasr-0.5.5/funasr/modules/streaming_utils/chunk_utilis.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/streaming_utils/load_fr_tf.py` & `funasr-0.5.5/funasr/modules/streaming_utils/load_fr_tf.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/streaming_utils/utils.py` & `funasr-0.5.5/funasr/modules/streaming_utils/utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/subsampling.py` & `funasr-0.5.5/funasr/modules/subsampling.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/modules/subsampling_without_posenc.py` & `funasr-0.5.5/funasr/modules/subsampling_without_posenc.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/optimizers/fairseq_adam.py` & `funasr-0.5.5/funasr/optimizers/fairseq_adam.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/optimizers/sgd.py` & `funasr-0.5.5/funasr/optimizers/sgd.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/demo.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/demo.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/funasr_torch/paraformer_bin.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/funasr_torch/paraformer_bin.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/funasr_torch/utils/compute_wer.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/funasr_torch/utils/compute_wer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/funasr_torch/utils/frontend.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/funasr_torch/utils/frontend.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/funasr_torch/utils/postprocess_utils.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/funasr_torch/utils/postprocess_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/funasr_torch/utils/timestamp_utils.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/funasr_torch/utils/timestamp_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/funasr_torch/utils/utils.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/funasr_torch/utils/utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/libtorch/setup.py` & `funasr-0.5.5/funasr/runtime/python/libtorch/setup.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/demo_paraformer_offline.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/demo_paraformer_offline.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/demo_punc_offline.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/demo_punc_offline.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/demo_punc_online.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/demo_punc_online.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/demo_vad_online.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/demo_vad_online.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/paraformer_bin.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/paraformer_bin.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/punc_bin.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/punc_bin.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/utils/e2e_vad.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/utils/e2e_vad.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/utils/frontend.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/utils/frontend.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/utils/postprocess_utils.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/utils/postprocess_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/utils/timestamp_utils.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/utils/timestamp_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/utils/utils.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/utils/utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/funasr_onnx/vad_bin.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/funasr_onnx/vad_bin.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/runtime/python/onnxruntime/setup.py` & `funasr-0.5.5/funasr/runtime/python/onnxruntime/setup.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/samplers/build_batch_sampler.py` & `funasr-0.5.5/funasr/samplers/build_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/samplers/folded_batch_sampler.py` & `funasr-0.5.5/funasr/samplers/folded_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/samplers/length_batch_sampler.py` & `funasr-0.5.5/funasr/samplers/length_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/samplers/num_elements_batch_sampler.py` & `funasr-0.5.5/funasr/samplers/num_elements_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/samplers/sorted_batch_sampler.py` & `funasr-0.5.5/funasr/samplers/sorted_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/samplers/unsorted_batch_sampler.py` & `funasr-0.5.5/funasr/samplers/unsorted_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/schedulers/abs_scheduler.py` & `funasr-0.5.5/funasr/schedulers/abs_scheduler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/schedulers/noam_lr.py` & `funasr-0.5.5/funasr/schedulers/noam_lr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/schedulers/tri_stage_scheduler.py` & `funasr-0.5.5/funasr/schedulers/tri_stage_scheduler.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/schedulers/warmup_lr.py` & `funasr-0.5.5/funasr/schedulers/warmup_lr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/abs_task.py` & `funasr-0.5.5/funasr/tasks/abs_task.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/asr.py` & `funasr-0.5.5/funasr/tasks/asr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/data2vec.py` & `funasr-0.5.5/funasr/tasks/data2vec.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/diar.py` & `funasr-0.5.5/funasr/tasks/diar.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/lm.py` & `funasr-0.5.5/funasr/tasks/lm.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/punctuation.py` & `funasr-0.5.5/funasr/tasks/punctuation.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/sa_asr.py` & `funasr-0.5.5/funasr/tasks/sa_asr.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/sv.py` & `funasr-0.5.5/funasr/tasks/sv.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/tasks/vad.py` & `funasr-0.5.5/funasr/tasks/vad.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/build_tokenizer.py` & `funasr-0.5.5/funasr/text/build_tokenizer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/char_tokenizer.py` & `funasr-0.5.5/funasr/text/char_tokenizer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/cleaner.py` & `funasr-0.5.5/funasr/text/cleaner.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/korean_cleaner.py` & `funasr-0.5.5/funasr/text/korean_cleaner.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/phoneme_tokenizer.py` & `funasr-0.5.5/funasr/text/phoneme_tokenizer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/sentencepiece_tokenizer.py` & `funasr-0.5.5/funasr/text/sentencepiece_tokenizer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/token_id_converter.py` & `funasr-0.5.5/funasr/text/token_id_converter.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/text/word_tokenizer.py` & `funasr-0.5.5/funasr/text/word_tokenizer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/torch_utils/add_gradient_noise.py` & `funasr-0.5.5/funasr/torch_utils/add_gradient_noise.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/torch_utils/device_funcs.py` & `funasr-0.5.5/funasr/torch_utils/device_funcs.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/torch_utils/forward_adaptor.py` & `funasr-0.5.5/funasr/torch_utils/forward_adaptor.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/torch_utils/initialize.py` & `funasr-0.5.5/funasr/torch_utils/initialize.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/torch_utils/load_pretrained_model.py` & `funasr-0.5.5/funasr/torch_utils/load_pretrained_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/torch_utils/model_summary.py` & `funasr-0.5.5/funasr/torch_utils/model_summary.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/torch_utils/recursive_op.py` & `funasr-0.5.5/funasr/torch_utils/recursive_op.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/train/abs_model.py` & `funasr-0.5.5/funasr/train/abs_model.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/train/class_choices.py` & `funasr-0.5.5/funasr/train/class_choices.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/train/distributed_utils.py` & `funasr-0.5.5/funasr/train/distributed_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/train/reporter.py` & `funasr-0.5.5/funasr/train/reporter.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/train/trainer.py` & `funasr-0.5.5/funasr/train/trainer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/asr_env_checking.py` & `funasr-0.5.5/funasr/utils/asr_env_checking.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/asr_utils.py` & `funasr-0.5.5/funasr/utils/asr_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/build_dataclass.py` & `funasr-0.5.5/funasr/utils/build_dataclass.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/cli_utils.py` & `funasr-0.5.5/funasr/utils/cli_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/compute_eer.py` & `funasr-0.5.5/funasr/utils/compute_eer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/compute_min_dcf.py` & `funasr-0.5.5/funasr/utils/compute_min_dcf.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/compute_wer.py` & `funasr-0.5.5/funasr/utils/compute_wer.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/config_argparse.py` & `funasr-0.5.5/funasr/utils/config_argparse.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/get_default_kwargs.py` & `funasr-0.5.5/funasr/utils/get_default_kwargs.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/griffin_lim.py` & `funasr-0.5.5/funasr/utils/griffin_lim.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/job_runner.py` & `funasr-0.5.5/funasr/utils/job_runner.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/misc.py` & `funasr-0.5.5/funasr/utils/misc.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/modelscope_param.py` & `funasr-0.5.5/funasr/utils/modelscope_param.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/modelscope_utils.py` & `funasr-0.5.5/funasr/utils/modelscope_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/nested_dict_action.py` & `funasr-0.5.5/funasr/utils/nested_dict_action.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/postprocess_utils.py` & `funasr-0.5.5/funasr/utils/postprocess_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/prepare_data.py` & `funasr-0.5.5/funasr/utils/prepare_data.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/sized_dict.py` & `funasr-0.5.5/funasr/utils/sized_dict.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/timestamp_tools.py` & `funasr-0.5.5/funasr/utils/timestamp_tools.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/types.py` & `funasr-0.5.5/funasr/utils/types.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/vad_utils.py` & `funasr-0.5.5/funasr/utils/vad_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr/utils/wav_utils.py` & `funasr-0.5.5/funasr/utils/wav_utils.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/funasr.egg-info/PKG-INFO` & `funasr-0.5.5/funasr.egg-info/PKG-INFO`
...
### Comparing `funasr-0.5.4/funasr.egg-info/SOURCES.txt` & `funasr-0.5.5/funasr.egg-info/SOURCES.txt`
...
### Comparing `funasr-0.5.4/funasr.egg-info/requires.txt` & `funasr-0.5.5/funasr.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/setup.py` & `funasr-0.5.5/setup.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/tests/test_asr_inference_pipeline.py` & `funasr-0.5.5/tests/test_asr_inference_pipeline.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/tests/test_asr_vad_punc_inference_pipeline.py` & `funasr-0.5.5/tests/test_asr_vad_punc_inference_pipeline.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/tests/test_lm_pipeline.py` & `funasr-0.5.5/tests/test_lm_pipeline.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/tests/test_punctuation_pipeline.py` & `funasr-0.5.5/tests/test_punctuation_pipeline.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/tests/test_sv_inference_pipeline.py` & `funasr-0.5.5/tests/test_sv_inference_pipeline.py`

 * *Files identical despite different names*

### Comparing `funasr-0.5.4/tests/test_vad_inference_pipeline.py` & `funasr-0.5.5/tests/test_vad_inference_pipeline.py`
