# Comparing `tmp/irene_pro-0.0.41.tar.gz` & `tmp/irene_pro-0.0.42.tar.gz`
...
## Comparing `irene_pro-0.0.41.tar` & `irene_pro-0.0.42.tar`
...
### Comparing `irene_pro-0.0.41/PKG-INFO` & `irene_pro-0.0.42/irene_pro.egg-info/PKG-INFO`
...
### Comparing `irene_pro-0.0.41/README.md` & `irene_pro-0.0.42/README.md`
...
### Comparing `irene_pro-0.0.41/irene_pro/logic.py` & `irene_pro-0.0.42/irene_pro/logic.py`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.41/irene_pro/widgets.py` & `irene_pro-0.0.42/irene_pro/widgets.py`
...
### Comparing `irene_pro-0.0.41/irene_pro.egg-info/PKG-INFO` & `irene_pro-0.0.42/PKG-INFO`
...
### Comparing `irene_pro-0.0.41/setup.py` & `irene_pro-0.0.42/setup.py`
