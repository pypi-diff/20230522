# Comparing `tmp/lamadava-0.0.1.tar.gz` & `tmp/lamadava-1.0.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "lamadava-0.0.1.tar", last modified: Mon May 22 11:17:08 2023, max compression
+gzip compressed data, was "lamadava-1.0.0.tar", last modified: Wed Dec 15 09:39:23 2021, max compression
```

## Comparing `lamadava-0.0.1.tar` & `lamadava-1.0.0.tar`

### file list

```diff
@@ -1,18 +1,12 @@
-drwxr-xr-x   0 adw0rd     (501) staff       (20)        0 2023-05-22 11:17:08.478000 lamadava-0.0.1/
--rw-r--r--   0 adw0rd     (501) staff       (20)     1072 2023-05-11 17:49:04.000000 lamadava-0.0.1/LICENSE
--rw-r--r--   0 adw0rd     (501) staff       (20)     1012 2023-05-22 11:17:08.477868 lamadava-0.0.1/PKG-INFO
--rw-r--r--   0 adw0rd     (501) staff       (20)      661 2023-05-22 11:16:55.000000 lamadava-0.0.1/README.md
-drwxr-xr-x   0 adw0rd     (501) staff       (20)        0 2023-05-22 11:17:08.477147 lamadava-0.0.1/lamadava/
--rw-r--r--   0 adw0rd     (501) staff       (20)       95 2023-05-22 10:57:32.000000 lamadava-0.0.1/lamadava/__init__.py
--rw-r--r--   0 adw0rd     (501) staff       (20)       96 2023-05-22 10:57:32.000000 lamadava-0.0.1/lamadava/__version__.py
--rw-r--r--   0 adw0rd     (501) staff       (20)    28872 2023-05-22 11:00:16.000000 lamadava-0.0.1/lamadava/api.py
--rw-r--r--   0 adw0rd     (501) staff       (20)    30127 2023-05-22 11:00:16.000000 lamadava-0.0.1/lamadava/asyncapi.py
--rw-r--r--   0 adw0rd     (501) staff       (20)     4045 2023-05-22 10:57:32.000000 lamadava-0.0.1/lamadava/base.py
-drwxr-xr-x   0 adw0rd     (501) staff       (20)        0 2023-05-22 11:17:08.477706 lamadava-0.0.1/lamadava.egg-info/
--rw-r--r--   0 adw0rd     (501) staff       (20)     1012 2023-05-22 11:17:08.000000 lamadava-0.0.1/lamadava.egg-info/PKG-INFO
--rw-r--r--   0 adw0rd     (501) staff       (20)      284 2023-05-22 11:17:08.000000 lamadava-0.0.1/lamadava.egg-info/SOURCES.txt
--rw-r--r--   0 adw0rd     (501) staff       (20)        1 2023-05-22 11:17:08.000000 lamadava-0.0.1/lamadava.egg-info/dependency_links.txt
--rw-r--r--   0 adw0rd     (501) staff       (20)       22 2023-05-22 11:17:08.000000 lamadava-0.0.1/lamadava.egg-info/requires.txt
--rw-r--r--   0 adw0rd     (501) staff       (20)        9 2023-05-22 11:17:08.000000 lamadava-0.0.1/lamadava.egg-info/top_level.txt
--rw-r--r--   0 adw0rd     (501) staff       (20)       38 2023-05-22 11:17:08.478033 lamadava-0.0.1/setup.cfg
--rw-r--r--   0 adw0rd     (501) staff       (20)     1398 2023-05-22 11:11:01.000000 lamadava-0.0.1/setup.py
...
### Comparing `lamadava-0.0.1/LICENSE` & `lamadava-1.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `lamadava-0.0.1/PKG-INFO` & `lamadava-1.0.0/PKG-INFO`
...
### Comparing `lamadava-0.0.1/lamadava.egg-info/PKG-INFO` & `lamadava-1.0.0/lamadava.egg-info/PKG-INFO`
...
### Comparing `lamadava-0.0.1/setup.py` & `lamadava-1.0.0/setup.py`
