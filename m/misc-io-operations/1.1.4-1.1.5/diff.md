# Comparing `tmp/misc_io_operations-1.1.4.tar.gz` & `tmp/misc_io_operations-1.1.5.tar.gz`
...
## Comparing `misc_io_operations-1.1.4.tar` & `misc_io_operations-1.1.5.tar`
...
### Comparing `misc_io_operations-1.1.4/PKG-INFO` & `misc_io_operations-1.1.5/PKG-INFO`
...
### Comparing `misc_io_operations-1.1.4/misc_io_operations.egg-info/PKG-INFO` & `misc_io_operations-1.1.5/misc_io_operations.egg-info/PKG-INFO`
...
### Comparing `misc_io_operations-1.1.4/setup.py` & `misc_io_operations-1.1.5/setup.py`
