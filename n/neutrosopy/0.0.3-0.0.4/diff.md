# Comparing `tmp/neutrosopy-0.0.3.tar.gz` & `tmp/neutrosopy-0.0.4.tar.gz`
...
## Comparing `neutrosopy-0.0.3.tar` & `neutrosopy-0.0.4.tar`
...
### Comparing `neutrosopy-0.0.3/LICENSE` & `neutrosopy-0.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `neutrosopy-0.0.3/PKG-INFO` & `neutrosopy-0.0.4/PKG-INFO`
...
### Comparing `neutrosopy-0.0.3/pyproject.toml` & `neutrosopy-0.0.4/pyproject.toml`
...
### Comparing `neutrosopy-0.0.3/src/neutrosopy.egg-info/PKG-INFO` & `neutrosopy-0.0.4/src/neutrosopy.egg-info/PKG-INFO`
...
### Comparing `neutrosopy-0.0.3/tests/test_neutrosophic_number.py` & `neutrosopy-0.0.4/tests/test_neutrosophic_number.py`
