# Comparing `tmp/titiler.pgstac-0.3.3.tar.gz` & `tmp/titiler.pgstac-4.0.0.tar.gz`
...
+gzip compressed data, was "titiler.pgstac-4.0.0.tar", last modified: Mon May 22 13:57:21 2023, max compression
```

## Comparing `titiler.pgstac-0.3.3.tar` & `titiler.pgstac-4.0.0.tar`
...
+-rw-r--r--   0        0        0     1097 2023-05-22 13:56:42.367704 titiler.pgstac-4.0.0/LICENSE
+-rw-r--r--   0        0        0     4451 2023-05-22 13:56:42.367704 titiler.pgstac-4.0.0/README.md
+-rw-r--r--   0        0        0     2618 2023-05-22 13:56:42.495708 titiler.pgstac-4.0.0/pyproject.toml
+-rw-r--r--   0        0        0       44 2023-05-22 13:56:42.499709 titiler.pgstac-4.0.0/titiler/pgstac/__init__.py
+-rw-r--r--   0        0        0      874 2023-05-22 13:56:42.499709 titiler.pgstac-4.0.0/titiler/pgstac/db.py
+-rw-r--r--   0        0        0     3936 2023-05-22 13:56:42.499709 titiler.pgstac-4.0.0/titiler/pgstac/dependencies.py
+-rw-r--r--   0        0        0    37682 2023-05-22 13:56:42.499709 titiler.pgstac-4.0.0/titiler/pgstac/factory.py
+-rw-r--r--   0        0        0       91 2023-05-22 13:56:42.499709 titiler.pgstac-4.0.0/titiler/pgstac/logger.py
+-rw-r--r--   0        0        0     3860 2023-05-22 13:56:42.503708 titiler.pgstac-4.0.0/titiler/pgstac/main.py
+-rw-r--r--   0        0        0     6797 2023-05-22 13:56:42.503708 titiler.pgstac-4.0.0/titiler/pgstac/model.py
+-rw-r--r--   0        0        0    12695 2023-05-22 13:56:42.503708 titiler.pgstac-4.0.0/titiler/pgstac/mosaic.py
+-rw-r--r--   0        0        0     2642 2023-05-22 13:56:42.503708 titiler.pgstac-4.0.0/titiler/pgstac/reader.py
+-rw-r--r--   0        0        0     3518 2023-05-22 13:56:42.503708 titiler.pgstac-4.0.0/titiler/pgstac/settings.py
+-rw-r--r--   0        0        0      834 2023-05-22 13:56:42.503708 titiler.pgstac-4.0.0/titiler/pgstac/utils.py
+-rw-r--r--   0        0        0     5671 1970-01-01 00:00:00.000000 titiler.pgstac-4.0.0/PKG-INFO
```

### Comparing `titiler.pgstac-0.3.3/LICENSE` & `titiler.pgstac-4.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/README.md` & `titiler.pgstac-4.0.0/README.md`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/pyproject.toml` & `titiler.pgstac-4.0.0/pyproject.toml`
...
### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/db.py` & `titiler.pgstac-4.0.0/titiler/pgstac/db.py`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/dependencies.py` & `titiler.pgstac-4.0.0/titiler/pgstac/dependencies.py`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/factory.py` & `titiler.pgstac-4.0.0/titiler/pgstac/factory.py`
...
### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/main.py` & `titiler.pgstac-4.0.0/titiler/pgstac/main.py`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/model.py` & `titiler.pgstac-4.0.0/titiler/pgstac/model.py`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/mosaic.py` & `titiler.pgstac-4.0.0/titiler/pgstac/mosaic.py`
...
### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/reader.py` & `titiler.pgstac-4.0.0/titiler/pgstac/reader.py`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/settings.py` & `titiler.pgstac-4.0.0/titiler/pgstac/settings.py`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/titiler/pgstac/utils.py` & `titiler.pgstac-4.0.0/titiler/pgstac/utils.py`

 * *Files identical despite different names*

### Comparing `titiler.pgstac-0.3.3/PKG-INFO` & `titiler.pgstac-4.0.0/PKG-INFO`
...
+Metadata-Version: 2.1 Name: titiler.pgstac Version: 4.0.0 Summary: Connect
